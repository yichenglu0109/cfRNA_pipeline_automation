...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for wash_num in range(1, 4):
        ...
        wash_src = make_single_source(reagent_well(shared, ZYMO_PREP_TUBE), wash_total)
        p300.pick_up_tip()
    ...
    protocol.comment("Step 5 complete. Proceed to Step 5b with clean 2 mL elution tubes.")
